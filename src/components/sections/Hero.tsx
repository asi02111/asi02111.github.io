...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className={`relative min-h-[80vh] flex items-center overflow-hidden transition-colors duration-300 ${
        isDark ? 'bg-neutral-950' : 'bg-white'
      }`}
    >
      {/* Grid background */}
      ...
      <div className="max-w-7xl mx-auto px-10 w-full z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-24 lg:py-0">
          ...
          {/* Right — Morfolio-style circular stage */}
          <div
            className="hidden lg:flex justify-center items-end relative select-none overflow-visible"
            style={{ height: '50vh' }}
          >
            <style>{`
            ...
            {/* ── 1. Big solid filled circle (the "stage") ── */}
            <div
              style={{
                position: 'absolute',
                width: 420,
                ...
                background: isDark ? '#1a1f26' : '#e2e4e7',
                /* thick border ring — exactly like Morfolio */
                boxShadow: isDark
                  ? 'inset 0 0 0 14px #0e1318, 0 0 0 14px #0e1318, 0 0 0 28px #1e2530'
                  : 'inset 0 0 0 14px #d4d7db, 0 0 0 14px #d4d7db, 0 0 0 28px #c5c8cc',
              }}
            />

            {/* ── 2. Decorative dot — top-left of circle ── */}
            <div
              style={{
                position: 'absolute',
                width: 16,
                ...
                bottom: 390,
                left: 'calc(50% - 195px)',
                boxShadow: `0 0 0 5px ${isDark ? 'rgba(52,211,153,0.2)' : 'rgba(16,185,129,0.15)'}`,
                animation: 'float-dot 3s ease-in-out infinite',
              }}
            />

            {/* ── 3. Small dark dot — top-right ── */}
            <div
              style={{
                position: 'absolute',
                width: 22,
            ...
            {/* ── 4. Stats badge — bottom-right, overlapping circle ── */}
            <div
              style={{
                position: 'absolute',
                bottom: 60,
            ...
            {/* ── 5. Person photo — on top of everything, overflows circle upward ── */}
            <img
              src="/as.png"
              alt="Ashraful Islam"
              style={{
